<?php
    ...
    $data = $objWp2023Order->paginate(3);
    extract($data);
?>
<div class="wrap">
        ...
        <div class="tablenav top">
            ...
            <div class="alignleft actions">
                ...
                <select name="status" id="cat" class="postform">
                    ...
                    <option class="level-0" <?= $status == 'pending' ? 'selected' : ''; ?> value="pending">Đơn hàng mới</option>
                    <option class="level-0" <?= $status == 'completed' ? 'selected' : ''; ?> value="completed">Đơn đã hoàn thành</option>
                    <option class="level-0" <?= $status == 'canceled' ? 'selected' : ''; ?> value="canceled">Đơn đã hủy</option>
                </select>
                <input type="submit" id="post-query-submit" class="button" value="Lọc">		
            </div>
            <?php 
                include WP2023_PATH.'includes/admin_pages/elements/elm-paginate.php';
            ?>
            <br class="clear">
        </div>
